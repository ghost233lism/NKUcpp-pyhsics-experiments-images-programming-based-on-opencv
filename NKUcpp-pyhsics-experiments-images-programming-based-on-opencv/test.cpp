...
//void GetContoursPic(const string pSrcFileName, const char* pDstFileName)
//{
...
//		rect.points(rectpoint); // 获取旋转矩形的四个顶点
//		//与水平线的角度  
...
//void main()
//{
//	GetContoursPic("Resources/Resources/fapiao.png", "FinalImage.jpg");
//	waitKey();
//}
